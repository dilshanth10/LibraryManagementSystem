    ...
    <head>
        ...
        <script>
                ...
                $.ajax({
                    ...
                    complete: function (response) {
                        ...
                        $('#addBookSubClassification')
                                ...
                                .remove()
                                .end()
                                .append('<option value="">Select Sub Classification</option>');
                    },
            ...
            function loadAddBookPublishYear() {
                ...
                option = '<option value="">Select Publish Year</option>';
                ...
                $('#addBookLastPrintYear')
                        ...
                        .remove()
                        .end()
                        .append('<option value="">Select Last Print Year</option>');
            }
            ...
            function loadAllLastPrintYear(publishYear) {
                var date = new Date();
                option = '<option value="">Select Last Print Year</option>';
            ...
            function clearAddBookForm() {
                ...
                $("#bookId").removeClass("errorBorder");
            }
...
//                    },
                    /** removing error label when red border appers **/
...
//                    $("#addBookForm").validate().resetForm();
                ...
                $("#bookId").focusout(function () {
                    ...
                    $.ajax({
                        url: 'GetBookDetailsByIdController?bookId=' + bookId,
    ...
    <body>
            ...
            <div class="table-wrapper">
                <div class="table-title" style="background:#365631;">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="#addBookModal" id="btnAddBook" class="btn btn-success" data-toggle="modal" onclick="getAddBookMainClassification();loadAddBookPublishYear();
                                    clearAddBookForm();">
        ...
        <div id="addBookModal" class="modal fade">
            <div class="modal-dialog" style="max-width:60%;">
                <div class="modal-content">
                    <form id="addBookForm" method="get" action="AddBookController">
                        ...
                        <div class="modal-body col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="addBookLastPrintYear" name="addBookLastPrintYear">
                                    <option value="">Select Last Print Year</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>ISBN No</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" id="noofpages" name="noofpages" class="form-control">
                            </div>
                        </div>

                        <div class="modal-footer">
                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                            <input type="submit" class="btn btn-info" id="btnSave" value="Save" style="background: #54a754;">
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div id="editBookModal" class="modal fade">
            <div class="modal-dialog" style="max-width:60%;">
                <div class="modal-content">
                    <form method="get" id="editBookForm" action="EditBookController">
                        <div class="modal-header">
                        ...
                        <div class="modal-body col-md-6">
                            ...
                            <div class="form-group">
                                <label>No of Pages</label>
                                <input type="number" min="0" name="editNoOfPages" id="editNoOfPages" class="form-control" required>
                            </div>
                        </div>

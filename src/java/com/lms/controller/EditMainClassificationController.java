...
//        processRequest(request, response);
        ...
        String mainClassificationId = request.getParameter("editMainClassificationId");
        String mainClassificationName = request.getParameter("editMainClassificationName");

        mainClassification.setMainClassificationId(mainClassificationId);
        mainClassification.setMainClassificationName(mainClassificationName);

        mainClassificationDao.editMainClassification(mainClassification);

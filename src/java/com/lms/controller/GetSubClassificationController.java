 ...
 * @author Natsu
 */
@WebServlet(name = "GetSubClassificationController", urlPatterns = {"/GetSubClassificationController"})
public class GetSubClassificationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GetSubClassificationController</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GetSubClassificationController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<SubClassification> subClassificationList = subClassificationDao.getAllSubClassification();
        ...
        for(SubClassification subClassification : subClassificationList){
            ...
            subClassificationJson = mainClassificationBuilder

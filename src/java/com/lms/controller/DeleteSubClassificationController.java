...
//        String subClassificationId = request.getParameter("deleteSubClassificationId");
        ...
        List<BookClassification> bookClassificationList = new ArrayList<>();

        subClassificationDao.deleteSubClassification(subClassificationId);
        
        request.getRequestDispatcher("/GetBookClassificationBySubClassificationId").forward(request, response);
        //request.getRequestDispatcher("/GetSubClassificationController").forward(request, response);

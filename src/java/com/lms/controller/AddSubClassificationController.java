...
//        processRequest(request, response);
        ...
        String subClassificationName = request.getParameter("subClassificationName");
        String mainClassificationId = request.getParameter("addSubClassificationMainClassification");
